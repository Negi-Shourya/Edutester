...
PDF_PATH = os.path.join("neet", "2024 Neet.pdf")
OUT_DIR = os.path.join("neet-out", "2024")
...
# ---- option cells without text layer / garbled formulas ----
    ...
    out = {
        "key": "neet-2024",
        "title": "NEET (UG) 2024",
        "fullTitle": "NEET (UG) 2024 - National Eligibility cum Entrance Test",
        "examDate": "2024-05-05",
        "durationMinutes": 200,
    ...
    print(f"\n{'=' * 62}")
    print(f"Paper: neet-2024  questions: {len(valid)}  images: {placed} (in {img_count} q)")
