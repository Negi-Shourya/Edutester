#!/usr/bin/env python3
"""OCR all pages of the scanned NEET 2022 PDF and write a structured text dump."""
import fitz
import os
import sys
import tempfile
...
with open("neet-out/2022/ocr_dump.txt", "w", encoding="utf-8") as f:
    f.write("\n".join(out))
doc.close()
print("saved neet-out/2022/ocr_dump.txt", len(out), "lines")
