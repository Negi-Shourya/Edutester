...
const paperPath = "jee-out/28-jan-morning-2025/questions.json";
...
console.log(`Testing math tokenization and KaTeX rendering for Paper 7 (${paperData.questions.length} questions)...`);
