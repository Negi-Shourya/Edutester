#!/usr/bin/env node
/**
 * Seeds NEET 2020 extracted questions into the Supabase question bank.
 *
 * Reads neet-out/2020/questions.json + images, uploads images to storage,
 * inserts paper/sections/questions/options/keys into the database.
 *
 * The extractor emits questions in booklet order (Biology 1-90, Physics
 * 91-135, Chemistry 136-180) but numbers them for the site (Physics 1-45,
 * Chemistry 46-90, Biology 91-180), so they are sorted by site number here —
 * that is what fixes the section order to Physics, Chemistry, Biology, the
 * same as every other NEET paper.
 *
 * Run:  node scripts/seed-neet-2020.mjs [--force]
 */
...
const FOLDER = "neet-2020";
const YEAR = 2020;

const __dirname = dirname(fileURLToPath(import.meta.url));
const OUT_DIR = join(__dirname, "..", "neet-out", "2020");
