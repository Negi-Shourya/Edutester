#!/usr/bin/env node
/**
 * Seeds NEET 2017 extracted questions into the Supabase question bank.
 *
 * Reads neet-out/2017/questions.json + images, uploads images to storage,
 * inserts paper/sections/questions/options/keys into the database.
 *
 * Run:  node scripts/seed-neet-2017.mjs [--force]
 */
...
const FOLDER = "neet-2017";
const YEAR = 2017;

const __dirname = dirname(fileURLToPath(import.meta.url));
const OUT_DIR = join(__dirname, "..", "neet-out", "2017");
