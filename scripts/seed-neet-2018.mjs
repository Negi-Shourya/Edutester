#!/usr/bin/env node
/**
 * Seeds NEET 2018 extracted questions into the Supabase question bank.
 *
 * Reads neet-out/2018/questions.json + images, uploads images to storage,
 ...
 *
 * Run:  node scripts/seed-neet-2018.mjs [--force]
 */
...
const FOLDER = "neet-2018";
const YEAR = 2018;

const __dirname = dirname(fileURLToPath(import.meta.url));
const OUT_DIR = join(__dirname, "..", "neet-out", "2018");
