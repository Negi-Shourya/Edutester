#!/usr/bin/env node
/**
 * Read-only: dump NEET 2023 Chemistry questions (numbers 51-100) with
 * full stem + options from Supabase, flagging blank/missing text.
 *
 * Run:  node scripts/_dump-neet-2023-chem.mjs
 */
...
console.log(`\nFlagged questions: ${flagCount} / ${chem.length}`);
process.exit(0);
